...
const projects = [
  ...
  },
  {
    name: "To-Do App ",
    description:
      "A simple To-Do app that can record the tasks along with the date and time of creation and are listed separately as pending and completed and also lists the deleted tasks",
    stack: ["React", "NodeJS", "Express", "MongoDB"],
